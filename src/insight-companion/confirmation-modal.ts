...
export interface ConfirmationData {
	...
	costEstimate: { inputCost: number; outputCost: number; totalCost: number; modelType: 'turbo' | 'legacy' };
	limitCheck: { 
...
export class ConfirmationModal extends Modal {
	...
	private createActionButtons(containerEl: HTMLElement) {
		...
		if (!limitCheck.withinGPT4TurboLimit) {
			...
			if (this.confirmButton.classList) {
