...
- [[Another Note]]: what stood out or felt odd`;
		} else if (config.insightStyle === 'succinct') {
			return `You're an assistant summarising a group of notes. Be concise, factual, and neutral. Your goal is to produce a clear, readable summary that reflects the key contents of the notes — without guessing intent or adding interpretation.
...
${finalConfig.insightStyle === 'freeform' 
	...
	: finalConfig.insightStyle === 'succinct'
	? 'Write in succinct style and end with a "Notes Referenced" section listing all the notes that were analyzed.'
