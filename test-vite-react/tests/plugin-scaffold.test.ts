...
describe('Plugin Scaffold Tests', () => {
  ...
  describe('Plugin Loading', () => {
    ...
    it('should load settings during plugin initialization', async () => {
      const loadSettingsSpy = jest.spyOn(plugin, 'loadSettings').mockResolvedValue(undefined);
      await plugin.onload();
  ...
  describe('Settings Management', () => {
    it('should have default settings structure after loading with no data', async () => {
      // Mock loadData to return empty object (simulating no saved data)
